...
<a href="index.html#section-respuestas">
    <!--se ícono de home-->
        <img class="home" src="img/hogar.webp" alt="">
    </a>
    <div class="main-frame-cal">
    <form action="" method="GET">
        <div class="form-group">
            <!--se reasignan las denominaciones para ingresar datos, de una manera más formal-->
        ...
        <div class="form-group">
            <label for="exampleFormControlInput1">C.C.</label>
            <input type="text" name="cc" class="form-control" id="exampleFormControlInput1" placeholder="Por favor, ingrese su  Cédula">
        </div>
